#!/usr/bin/env bash
# =============================================================================
# C4K Inventory Management System — Local Setup Script
# =============================================================================
# Usage:   bash setup.sh
...
# ── Terminal colors (gracefully degraded when not a TTY) ─────────────────────
if [[ -t 1 ]]; then
    RED='\033[0;31m'
    GREEN='\033[0;32m'
    YELLOW='\033[1;33m'
...
# Frontend build argument — embedded into the React JS bundle at build time
REACT_APP_BACKEND_URL=${REACT_APP_BACKEND_URL}
ENVFILE
    success "Root .env written."

    # frontend/.env.local — used if running 'yarn start' locally (not in Docker)
...
ENVFILE
    ...
    # backend/.env — used when running 'uvicorn' locally (not in Docker)
...
# C4K Inventory System — Nginx Configuration
